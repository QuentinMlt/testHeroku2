...
describe('Task', () => {
    test('Should pass confirmation data', async () => {
        const register = await request(app).post('/register').send({id: 1, email: "email@email.com", username: "quentin", password: "1234"}).expect(201);
    ...
    test('Should find object', async () => {
        const register = await request(app).post('/register').send({id: 2, email: "email@email.com", username: "quentin", password: "1234"}).expect(201);
        const login = await request(app).post('/login').send({email: "email@email.com", password: "1234"}).expect(200);
...
describe('Task Update', () => {
    test('Should update one entry', async () => {
        const register = await request(app).post('/register').send({id: 3, email: "email@email.com", username: "quentin", password: "1234"}).expect(201);
        const login = await request(app).post('/login').send({email: "email@email.com", password: "1234"}).expect(200);
...
describe('Task Delete', () => {
    test('Should delete one entry', async () => {
        const register = await request(app).post('/register').send({id: 4,email: "email@email.com", username: "quentin", password: "1234"}).expect(201);
        const login = await request(app).post('/login').send({email: "email@email.com", password: "1234"}).expect(200);
    ...
    test('Should not delete task of other user', async () => {
        const register1 = await request(app).post('/register').send({id: 5,email: "email@email.com", username: "quentin", password: "1234"}).expect(201);
